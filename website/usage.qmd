...
From next section (@sec-step-by-step), each step will be explained in detail.
...
1.  \[Add Layer\] をクリックします。Scale Measurement という シェープレイヤー ![](assets/icons\new_shapes.svg){width="24"} が追加されます
2.  \[mode\]を "px/cm" に設定します
3.  スケールバーを拡大し、\[Add lines\] ![](assets/icons\rectangle.svg){width="24"} ツールが選択されていることを確認します
...
-   間違えた矩形を描画した場合は、\[Delete selected shapes\] ![](assets/icons/delete_shape.svg){width="24"} ツールで矩形を消去し、再度矩形を追加してください。
